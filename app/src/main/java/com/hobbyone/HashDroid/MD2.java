 ...
 * 
 * <ol>
 * <li>The <a href="http://www.ietf.org/rfc/rfc1319.txt">MD2</a> Message-Digest
 * Algorithm.<br>
 * B. Kaliski.</li>
...
public class MD2 extends BaseHash {
	...
	private static final byte[] PI = { 41, 46, 67, -55, -94, -40, 124, 1, 61,
	 ...
	 * 
	 * @param in
	 *            the byte array to take the <code>BLOCK_LENGTH</code> bytes
	 *            from.
	 * @param off
