 ...
 * <i>HAVAL</i> to be used as a drop-in replacement for <i>MD5</i>.
 * </p>
 * 
 * <p>
 * References:
...
public class Haval extends BaseHash {
	...
	private int t0, t1, t2, t3, t4, t5, t6, t7;
	private int X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13,
	 ...
	 * @see #HAVAL_5_ROUND
	 */
	private Haval(int size, int rounds) {
		super("haval", size, BLOCK_SIZE);
	...
	protected synchronized void transform(byte[] in, int i) {
		X0 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X1 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X2 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X3 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X4 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X5 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X6 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X7 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X8 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X9 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X10 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X11 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X12 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X13 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X14 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X15 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X16 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X17 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X18 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X19 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X20 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X21 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X22 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X23 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X24 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X25 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X26 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X27 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X28 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X29 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X30 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
		X31 = (in[i++] & 0xFF) | (in[i++] & 0xFF) << 8 | (in[i++] & 0xFF) << 16
				| (in[i++] & 0xFF) << 24;
