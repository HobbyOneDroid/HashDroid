...
public class RipeMD160 extends BaseHash {
    ...
    private static final int[] Rp = {5, 14, 7, 0, 9, 2, 11, 4, 13, 6, 15, 8,
    ...
    private static final int[] S = {11, 14, 15, 12, 5, 8, 7, 9, 11, 13, 14,
     ...
     */
    public RipeMD160() {
        super("ripemd-160", 20, BLOCK_SIZE);
    }
    ...
    protected byte[] getResult() {
        byte[] result = new byte[]{(byte) h0, (byte) (h0 >>> 8),
                ...
                (byte) (h3 >>> 16), (byte) (h3 >>> 24), (byte) h4,
                (byte) (h4 >>> 8), (byte) (h4 >>> 16), (byte) (h4 >>> 24)};
